...
import stable_baselines3_thesis as sb3
from stable_baselines3_thesis.common.type_aliases import TensorDict
from stable_baselines3_thesis.common.utils import get_device, get_system_info
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(save_path, mode="w") as archive:
        ...
        archive.writestr("_stable_baselines3_thesis_version", sb3.__version__)
